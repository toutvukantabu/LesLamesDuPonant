...
return [
    ...
    'supprimer_how_we_are' => [['id'], ['_controller' => 'App\\Controller\\HowWeAreController::supprimer'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/how/we/are/supprimer']], [], []],
    'activer_how_we_are' => [['id'], ['_controller' => 'App\\Controller\\HowWeAreController::activer'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/how/we/are/activer']], [], []],
