...
return [
    ...
    'le_forum_category' => [['id'], ['_controller' => 'App\\Controller\\LeForumController::showCategory'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/forum/categories']], [], []],
    'le_forum_subject' => [['id'], ['_controller' => 'App\\Controller\\LeForumController::showMessage'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/forum/categories/sujet']], [], []],
